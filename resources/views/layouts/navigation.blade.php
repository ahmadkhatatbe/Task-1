                ...
                <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                    ...
                    <header class="relative bg-white dark:bg-darker">
                        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                            ...
                            <nav aria-label="Secondary"style="margin-left: 10px" class="hidden space-x-2 md:flex md:items-center mx-5">
                                ...
                                <div class="relative " x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-ref="userMenu"
                                        ...
                                        class="absolute left-0 w-48 py-1 origin-top-left bg-white rounded-md shadow-lg top-12 ring-1 ring-black ring-opacity-5 dark:bg-dark"
                                        ...
                                        <form action="{{ route('logout') }}" method="post">
                                            @csrf
                                            <button
                                                class="block ml-5 px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"type="submit">
                                                تسجيل الخروج
                            ...
                            <nav x-transition:enter="transition duration-200 ease-in-out transform sm:duration-500"
                                ...
                                <!-- User avatar button -->
                                <div class="relative ml-auto" style="margin-left: 10px" x-data="{ open: false }">
