...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url('https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css') }}">
            ...
            <div class="menu-bg-wrap">
                <div class="site-navigation">
                    <div class="row g-0 align-items-center">
                        <div class="col-2">
                            <a href="index.html" class="logo m-0 float-start">مقالي<span
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="widget">
                        ...
                        <p>بعيدًا جدًا، خلف جبال الكلمة، بعيدًا عن بلاد فوكاليا وكونسونانتيا، هناك تعيش النصوص العمياء.
                        </p>
                    </div> <!-- /.widget -->
                    <div class="widget">
                        <h3>Social</h3>
