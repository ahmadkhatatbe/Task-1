                            ...
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start">
                                        <img src="{{ url('images/person_1.jpg') }}" alt="Image" class="img-fluid">
                                    </figure>
                                    <span class="d-inline-block mt-1">
                                        By <a href="{{ route('single', $article->id) }}">{{ $article->user->name }}</a>
                                ...
                                <p>
                                    <a href="{{ route('single', $article->id) }}" class="read-more">
                                        Continue Reading
                                    </a>
                                </p>
                            </div>
